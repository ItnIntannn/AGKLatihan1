...
LoadImage(1,"ikan-paus.jpg") // Load Gambar di Folder di Folder media, ID Image = 1

CreateSprite(1, 1) // Membuat Sprite dari gambar 1, ID Sprite = 1
SetSpriteScale(1, 0.2, 0.2) // Merubah Ukuran Sprite ID 1
SetSpriteSize(1, 200, 200) // selain menggunakan scale ukuran sprite juga bisa di rubah dengan sintax
